...
const Difference = () => {
	return (
		<section className="  section-2 " id="diferenca">
			<div className="lg:min-h-screen min-h-max lg:my-0 my-20 grid content-center  grid-cols-1 md:grid-cols-2">
				<div>
					...
					<p className="lg:text-xl md:text-lg text-sm mb-2">
						...
						perdidos, atividades que geravam prazer, não geram mais e a pessoa
						não tem perspectiva de que algo possa ser feito para que melhore seu
						quadro.
					</p>
					<em className="md:text-base text-xs text-gray-700">
						Está sentindo algum sintoma parecido? Procure um médico especialista
						imediatamente, depressão é uma doença séria, mas com ajuda é
						possível se recuperar.
					</em>
					<br />
