		...
		<div className="header flex justify-between items-center md:px-20 px-5 h-20 w-full max-w-full border-b-2 fixed bg-white z-10">
			...
			>
				<AiOutlineClose
					...
					onClick={toggleMenu}
				/>
				<div className="md:hidden flex flex-col border-b-2 w-full pb-5">
				...
				<div className="md:hidden flex flex-col">
					<a
						href="#definicao"
						onClick={toggleMenu}
						className="py-5 hover:border-b-2 hover:border-gray-400 border-b-2 border-transparent transition-all"
					>
						O que é
					</a>
					<a
					...
					<Link
						to="/ajuda"
						onClick={toggleMenu}
						className="my-5 lg:px-10 px-5 ml-5 py-2 rounded-full bg-green-500 hover:bg-green-600 text-white  "
					>
						Ajuda
					</Link>
				</div>
